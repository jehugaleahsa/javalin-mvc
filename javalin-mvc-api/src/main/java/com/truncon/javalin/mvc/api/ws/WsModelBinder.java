...
/**
 * Performs model binding for retrieving values from the WebSocket context.
 */
public interface WsModelBinder {
    /**
     * Gets a value from the context for a parameter with the given name and type. Normally,
     ...
     */
    Object getValue(String name, Class<?> parameterClass, WsValueSource valueSource);
}
