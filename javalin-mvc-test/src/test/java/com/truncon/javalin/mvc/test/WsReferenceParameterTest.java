...
final class WsReferenceParameterTest {
    @Test
    ...
    @Test
    void testOffsetDateTime() throws IOException {
    ...
    @Test
    void testZonedDateTime() throws IOException {
    ...
    @Test
    void testLocalDate() throws IOException {
    ...
    @Test
    void testYearMonth() throws IOException {
