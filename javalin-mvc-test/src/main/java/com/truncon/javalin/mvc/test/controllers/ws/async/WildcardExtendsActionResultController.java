...
@WsController(route = WildcardExtendsActionResultController.ROUTE)
public final class WildcardExtendsActionResultController {
    public static final String ROUTE = "/ws/async/wildcard/action_result";
    ...
    @WsMessage
    public CompletableFuture<? extends WsActionResult> onMessage(PrimitiveModel model) {
